...
oddFactorial n =
  case (even n) of
    True -> oddFactorial (n - 1)
    False ->
      case (n == 1) of
        True -> 1
        False -> n * oddFactorial (n - 2)
...
countdown n = "Ready! " ++ countdown_helper n

countdown_helper :: Integer -> String
countdown_helper n =
  case (n == 0) of
    True -> "Liftoff!"
    False -> show n ++ "... " ++ countdown_helper (n - 1)
